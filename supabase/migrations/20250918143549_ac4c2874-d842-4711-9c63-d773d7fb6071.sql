-- Drop and recreate the bulk_update_resource_planning RPC function to fix field name mismatches
DROP FUNCTION IF EXISTS public.bulk_update_resource_planning(jsonb);
