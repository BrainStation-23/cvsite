...
-- Drop the old version of the function to avoid conflicts
DROP FUNCTION IF EXISTS public.get_resource_planning_data(text, integer, integer, text, text);

-- Ensure we have the correct version with all parameters
