    ...
    Papa.parse(text, {
      ...
      transformHeader: (header: string) => {
        ...
        const headerMap: Record<string, string> = {
          ...
          'sbucontextid': 'sbuContextId',
          'sbu_context_id': 'sbuContextId',
          'sbucontextname': 'sbuContextName',
          'sbu_context_name': 'sbuContextName',
        ...
        const users = results.data
          ...
          .map((row: any) => {
            ...
            return {
              ...
              customRoleId: row.customRoleId?.trim(),
              customRoleName: row.customRoleName?.trim(),
              sbuContextId: row.sbuContextId?.trim(),
              sbuContextName: row.sbuContextName?.trim(),
