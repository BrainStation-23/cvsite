      ...
      try {
        ...
        if (data) {
          ...
          const employeeObj = {
            ...
            biography: data.biography || data.general_information?.biography || '',
            currentDesignation: data.current_designation || data.general_information?.current_designation || '',
            profileImage: data.profile_image || data.general_information?.profile_image || '',
