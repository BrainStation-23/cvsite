...
export function useEmployeeProfileEditor(profileId: string) {
  ...
  const updateExperience = async (id: string, experience: Partial<Experience>) => {
    ...
    try {
      ...
      if (experience.endDate !== undefined) updateData.end_date = experience.endDate ?? null;
  ...
  const updateEducation = async (id: string, education: Partial<Education>) => {
    ...
    try {
      ...
      if (education.endDate !== undefined) updateData.end_date = education.endDate ?? null;
  ...
  const updateProject = async (id: string, project: Partial<Project>) => {
    ...
    try {
      ...
      if (project.endDate !== undefined) updateData.end_date = project.endDate ?? null;
