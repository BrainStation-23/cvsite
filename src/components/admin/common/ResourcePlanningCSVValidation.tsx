...
import { CSVValidationResult, CSVValidationError } from '@/utils/resourcePlanningCsvUtils';

interface ResourcePlanningCSVValidationProps {
  validationResult: CSVValidationResult;
  fileName: string;
}

export const ResourcePlanningCSVValidation: React.FC<ResourcePlanningCSVValidationProps> = ({
  validationResult,
  fileName
}) => {
