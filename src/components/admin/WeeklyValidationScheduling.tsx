...
import { useWeeklyValidationCron } from '@/hooks/use-weekly-validation-cron';

const WeeklyValidationScheduling: React.FC = () => {
  const { config, isLoading, updateCronJob, isUpdating } = useWeeklyValidationCron();
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure automatic weekly validation reset using cron jobs. This will reset all weekly_validation flags to false on the specified schedule.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label htmlFor="cron-enabled" className="text-base font-medium">
                Enable Scheduled Reset
              </Label>
              <p className="text-sm text-muted-foreground">
                Turn on/off the automatic weekly validation reset
              </p>
            </div>
            <Switch
              id="cron-enabled"
          ...
          <Alert>
            ...
            <AlertDescription>
              This cron job will automatically reset all weekly validation flags in the resource planning table. 
              Make sure the schedule aligns with your business processes.
            </AlertDescription>
          </Alert>
...
export default WeeklyValidationScheduling;
