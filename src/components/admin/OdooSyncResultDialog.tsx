...
<Dialog open={isOpen} onOpenChange={onOpenChange}>
  <DialogContent className="max-w-5xl h-[90vh] flex flex-col">
    ...
    <div className="flex-1 overflow-y-auto">
      {/* Not Found Employees Section */}
      {not_found_employees.length > 0 && (
        <div className="mb-6">
          {/* Header and Actions - Always visible when scrolled to top */}
          ...
          {onBulkUpload && (
            <div className="flex items-center gap-4 mb-3 p-3 bg-gray-50 rounded-md  z-10">
              <div className="flex items-center gap-2">
                <Checkbox
                  id="select-all"
          ...
          {/* Employee List - This will scroll naturally */}
