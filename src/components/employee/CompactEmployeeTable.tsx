...
const CompactEmployeeTable: React.FC<CompactEmployeeTableProps> = ({
  ...
  const formatExperienceYears = (years: number | null | undefined) => {
                ...
                <TableCell>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {profile.general_information?.biography && (
                        <Tooltip>
                          <TooltipTrigger asChild>
                          ...
                          <TooltipContent>
                            <p className="max-w-[300px]">{profile.general_information.biography}</p>
                          </TooltipContent>
                        </Tooltip>
                      )}
                    </div>
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <div className="flex items-center gap-1">
                            ...
                            <span>{formatExperienceYears(profile.total_experience_years)} total</span>
                          </div>
                        </TooltipTrigger>
                        <TooltipContent>
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <div className="flex items-center gap-1">
                            ...
                            <span>{formatExperienceYears(profile.company_experience_years)} here</span>
                          </div>
                        </TooltipTrigger>
                        <TooltipContent>
